...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: GonderilenMesajDetayMuvekkil(),
    );
  }
}

class GonderilenMesajDetayMuvekkil extends StatefulWidget {
  @override
  _GonderilenMesajDetayMuvekkilState createState() =>
      _GonderilenMesajDetayMuvekkilState();
}

class _GonderilenMesajDetayMuvekkilState
    extends State<GonderilenMesajDetayMuvekkil> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  final FirebaseStorage _storage = FirebaseStorage.instance;

  Future<bool> onBackPressed() {
    Navigator.push(
        context, MaterialPageRoute(builder: (_) => GonderilenlerMuvekkil()));
