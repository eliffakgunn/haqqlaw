...
import 'package:haqqlaw/gelen_kutusu_muvekkil.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: GelenMesajDetayMuvekkil(),
    );
  }
}

class GelenMesajDetayMuvekkil extends StatefulWidget {
  @override
  _GelenMesajDetayMuvekkilState createState() =>
      _GelenMesajDetayMuvekkilState();
}

class _GelenMesajDetayMuvekkilState extends State<GelenMesajDetayMuvekkil> {
  ...
  Future<bool> onBackPressed() {
    Navigator.push(
        context, MaterialPageRoute(builder: (_) => GelenKutusuMuvekkil()));
  ...
  Widget build(BuildContext context) {
    ...
    String? avukatID = datas['avukatID'];
                        ...
                        child: FlatButton(
                          onPressed: () async {
                            sendReply(kategori!, konu, icerik, muvekkilAdi!,
                                muvekkilID!, avukat, avukatID!, tarih);
                          },
                          child: Text(
                            'Gönder',
                            style: TextStyle(
